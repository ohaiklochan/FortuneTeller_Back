...
class CookiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cooky" do
    assert_difference('Cookie.count') do
      post cookies_url, params: { cooky: { fortune: @cooky.fortune, meaning: @cooky.meaning } }, as: :json
    end
  ...
  test "should update cooky" do
    patch cooky_url(@cooky), params: { cooky: { fortune: @cooky.fortune, meaning: @cooky.meaning } }, as: :json
    assert_response 200
  end
